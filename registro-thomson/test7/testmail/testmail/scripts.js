...
function handleFormSubmit(ele) {
    $(function () {
        $.ajax({
            ...
            beforeSend: function () {
		location.href="https://webinarbms.com/thomson/test6/sendmail.php?email="+$(".email_ajax").val();
...
var dom8 = document.querySelector('#form4529 #fe52867');

var fe52867 = new LiveValidation(dom8, {
